...
export class EnergyMeterComponent implements OnInit {
  ...
  constructor(
    ...
    this.filters = { limit: 10, offset: '0', device_type: 'Energy Meter', customer_id: this.customerId, order_by: '', order: '', search: '', device: '', building: '', space: '', space_attribute: '', open_area: '', export: '' };
  ...
  onDeviceSignals(ev: any) {
    ...
    if (ev.type === 'onDelete') {
      ...
      this.router.navigate(['/ss/utilities/energy-meter-details', ev.row['device']]);
