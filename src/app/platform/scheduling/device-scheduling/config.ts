...
export class SchedulingTableConfig {
    public static config = {
        ...
        columns: [
            ...
            { name: 'device_online', title: 'Schedule Status', sortable: true, sortingOutside: false ,format: 'schedule-status' },
...
function sch(v: any, r?: any, c?: any): any
{
...
export const SCHEDULED: any = (v: any, r?: any, c?: any) => sch(v, r, c);
