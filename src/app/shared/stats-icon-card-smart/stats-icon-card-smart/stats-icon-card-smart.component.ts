...
@Component({
  selector: 'app-stats-icon-card-smart',
  templateUrl: './stats-icon-card-smart.component.html',
  styleUrls: ['./stats-icon-card-smart.component.scss']
})
export class StatsIconCardSmartComponent  {
